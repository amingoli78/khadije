...
public class f_one extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewone = inflater.inflate(R.layout.f_one, container, false);


        final WebView webView = viewone.findViewById(R.id.webview_one);
        WebSettings webSettings = webView.getSettings();
        webSettings.setJavaScriptEnabled(true);
        final SwipeRefreshLayout swipe = viewone.findViewById(R.id.swipref_one);
        //------------------------------------------------------------
