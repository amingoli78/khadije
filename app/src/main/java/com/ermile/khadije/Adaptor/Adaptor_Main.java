package com.ermile.khadije.Adaptor;
...
import com.ermile.khadije.Items.item_Main;
...
public class Adaptor_Main extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public QuranListAdaptor(ArrayList<item_Main> data, Context context ) {
        this.itemMains = data;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int listPosition) {
        ...
        final item_QuranList object = itemMains.get(listPosition);
        if (object != null) {
            switch (object.type) {
                case item_QuranList.SURAH_TYPE:
