...
/*    public static void GetJson(final Context context, final JsonLocalListener jsonLocalListener){
        StringRequest get_local = new StringRequest(Request.Method.GET, context.getString(R.string.url_app), new Response.Listener<String>()
        {
            @Override
        ...
        }, new Response.ErrorListener()
        {
            ...
            public void onErrorResponse(VolleyError error)
            {
                ...
                jsonLocalListener.onGetJson_OfflineNULL(valueJson);
            }
        });
    ...
    public interface JsonLocalListener {
        ...
        void onGetJson_OfflineNULL(String ResponeOffline);
    }*/

    public static void GetJson(final Context context, final JsonLocalListener jsonLocalListener){
        String AppLanguage = SaveManager.get(context).getstring_appINFO().get(SaveManager.appLanguage);

        StringRequest get_local = new StringRequest(Request.Method.GET, url.local+AppLanguage+"/"+url.app, new Response.Listener<String>()
        {
            @Override
            public void onResponse(String response)
            {
